...
using AutoLua.Droid.HttpServers;
using AutoLua.Droid.Monitors;
using HttpServer.Modules;

namespace AutoLua.Droid.Services
{
    [Register("AutoLua.Droid.Services.AutoNotificationService")]
    [Service(Name = "AutoLua.Droid.Services.AutoNotificationService", Enabled = true, Exported = true)]
    [IntentFilter(new[] { "Notification_Start", "Notification_Stop", }, Priority = 10000)]
    public class AutoNotificationService : Service
    {
        ...
        private static string CreateNotificationChannel(string channelId, string channelName)
        {
            ...
            var service = AppUtils.GetSystemService<NotificationManager>(NotificationService);
