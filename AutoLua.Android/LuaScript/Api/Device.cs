    ...
    public class Device
    {
        ...
        public float Battery
        {
            get
            {
                ...
                return Java.Lang.Math.Round(battery * 10) / 10;
            }
        }
        ...
        public bool IsCharging
        {
            get
            {
                ...
                if (intent == null)
                {
                    LogEventDelegates.Instance.OnLog(new LogEventArgs("异常", "Cannot retrieve the battery state", Color.Red));
        ...
        private bool CheckOp(Context context, string op)
        {
        ...
        private string GetMacByInterface()
        {
