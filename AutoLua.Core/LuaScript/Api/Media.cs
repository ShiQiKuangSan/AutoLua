...
using AutoLua.Core.LuaScript.ApiCommon.Medias;
using NLua.Exceptions;
using static Android.Media.MediaScannerConnection;
using static AutoLua.Core.LuaScript.Api.LuaFiles;
...
namespace AutoLua.Core.LuaScript.Api
{
    ...
    public class Media : Java.Lang.Object, IMediaScannerConnectionClient
    {
        ...
        public Media()
        {
            _scannerConnection = new MediaScannerConnection(AppUtils.AppContext, this);
